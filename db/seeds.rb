...
Mood.create(name: "adventurous")
Mood.create(name: "hungry")
Mood.create(name: "creative")
Mood.create(name: "hype")


Activity.create(name: "Zilker Park", 
...
Activity.create(name: "Barton Springs Pool", 
...
Activity.create(name: "Austin 360 Bridge", 
...
Activity.create(name: "Lady Bird Johnson Wildflower Center", 
...
Activity.create(name: "Greetings From Austin Mural", 
...
Activity.create(name: "Lake Travis Zipline Adventures", 
...
Activity.create(name: "River Place Nature Trail", 
...
Activity.create(name: "Twin Falls and Sculpture Falls Via Barton Creek Greenbelt Trail", 
...
Activity.create(name: "Bat Watching at Congress Avenue Bridge", 
...
Activity.create(name: "Austin Flyboard", 
...
Activity.create(name: "Home Slice Pizza", 
...
Activity.create(name: "Franklin Barbecue", 
...
Activity.create(name: "Ramen Tatsuya", 
...
Activity.create(name: "Gourdough's", 
 ...
 Activity.create(name: "The Salt Lick BBQ", 
...
Activity.create(name: "Cathedral of Junk", 
...
Activity.create(name: "Museum of the Weird", 
...
Activity.create(name: "HOPE Outdoor Gallery", 
...
Activity.create(name: "Wonderspace", 
...
Activity.create(name: "The Contemporary", 
...
Activity.create(name: "The Concourse Project", 
...
Activity.create(name: "Barbarella", 
 ...
 Activity.create(name: "Rainey Street District", 
 ...
 Activity.create(name: "Cidercade", 
...
Activity.create(name: "Dirty Sixth", 
